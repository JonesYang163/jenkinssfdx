...
node {
    ...
    withCredentials([file(credentialsId: JWT_KEY_CRED_ID, variable: 'jwt_key_file')]) {
		...
		rc = sh '/usr/local/bin/sfdx force:auth:jwt:grant --clientid ${CONNECTED_APP_CONSUMER_KEY} --username ${HUB_ORG} --jwtkeyfile /users/yjw/documents/jwt/server.key --setdefaultdevhubusername --instanceurl ${SFDC_HOST} --setalias my-hub-org'
